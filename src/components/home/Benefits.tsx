...
export default function Benefits() {
  ...
  return (
    <div 
      id="benefits" 
      className="bg-gray-950 relative w-full min-h-[600px] py-14 xs:py-16 sm:py-20 md:py-24 lg:py-28 overflow-hidden"
    ...
    >
      ...
      {/* Decorative dots - without animations */}
      <div className="absolute top-1/4 right-1/3 w-2 sm:w-3 h-2 sm:h-3 rounded-full bg-pink-400/50"></div>
      <div className="absolute bottom-1/4 left-1/4 w-2 sm:w-3 h-2 sm:h-3 rounded-full bg-indigo-400/50"></div>
      <div className="absolute top-1/2 right-1/4 w-3 sm:w-4 md:w-5 h-3 sm:h-4 md:h-5 rounded-full bg-cyan-400/50"></div>
      <div className="absolute top-2/3 left-1/2 w-2 h-2 rounded-full bg-purple-400/50"></div>
      <div className="absolute bottom-1/3 right-1/3 w-2 sm:w-3 h-2 sm:h-3 rounded-full bg-pink-300/50"></div>
      
      <div className="mx-auto max-w-7xl w-full px-4 xs:px-5 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
          ...
          {/* Benefits grid with responsive columns - changed to 2 columns across all breakpoints */}
