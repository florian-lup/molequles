  ...
  const skinFactors = [
    {
      title: 'Temperature',
      description:
        'Increases scent projection and evolution speed, allowing fragrance molecules to diffuse at different rates on your skin.',
    },
    {
      title: 'Hydration',
      description:
        'Maintains fragrance integrity and longevity, ensuring your personalized scent lasts throughout the day.',
    },
    {
      title: 'pH',
      description:
        'Influences the overall composition balance, affecting how certain fragrance notes present themselves on your skin.',
    },
    {
      title: 'Sebum',
      description:
        'Can enhance notes and accelerate oxidation, creating a unique signature scent that evolves with your natural oils.',
    },
  ];
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-8 md:mb-10 lg:mb-14">
          ...
          <p className="text-gray-600 text-xs md:text-lg lg:text-xl">
            Your body chemistry transforms every scent. Our algorithms analyze key factors to find
            the optimal fragrance blends for your skin
          </p>
        </div>
