    ...
    <section className="relative py-12 md:py-16 lg:py-24 bg-white">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mt-6 md:mt-8 lg:mt-10 mx-auto max-w-4xl">
          <div className="bg-white rounded-xl border p-4 md:p-6 border-gray-200 shadow-sm bg-[linear-gradient(#33333310_1px,transparent_1px),linear-gradient(90deg,#33333310_1px,transparent_1px)] bg-[size:16px_16px]">
